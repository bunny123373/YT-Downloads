      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-32 text-center">
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto">
          <div className="relative group">
            ...
            <div className="relative flex items-center bg-dark-900/80 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden">
              <button
                type="button"
                onClick={handlePaste}
                className="flex items-center gap-2 px-4 py-4 text-gray-400 hover:text-white transition-colors border-r border-white/10"
              >
              ...
              <input
                ...
                className="flex-1 bg-transparent text-white px-4 py-4 outline-none placeholder:text-gray-500"
              />
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="flex items-center gap-2 px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold hover:from-purple-500 hover:to-blue-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
